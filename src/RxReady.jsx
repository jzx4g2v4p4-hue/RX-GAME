...
const CALC_BANK = [
  ...
  // ── RENAL DOSE ADJUSTMENT — RETAIL DRUGS ──
  { id:"renal_cipro", cat:"Renal Dose Adjustment",
    scenario:"Ciprofloxacin 500 mg PO q12h for a UTI. Package insert: reduce to 250 mg q12h when CrCl < 30 mL/min. Patient CrCl = 22 mL/min.",
    q:"What is the correct dose for this patient?",
    opts:["125 mg q12h","250 mg q12h","500 mg q24h","500 mg q12h (no change)"], ans:1,
    work:"CrCl 22 mL/min < 30 mL/min → dose reduction required per PI.\nInterval stays q12h; dose halved to 250 mg q12h.\nAnswer: 250 mg q12h" },
  { id:"renal_gabapentin", cat:"Renal Dose Adjustment",
    scenario:"Gabapentin PI: CrCl 15–29 mL/min → max 300 mg/day (single daily dose). Patient CrCl = 22 mL/min. Prescriber wrote: Gabapentin 300 mg TID #90, 30-day supply.",
    q:"What is the pharmacist's next step?",
    opts:["Dispense as written — 900 mg/day","Contact prescriber: max dose is 300 mg/day for this CrCl","Dispense but reduce quantity to #30 tablets","Substitute gabapentin 100 mg capsules TID"], ans:1,
    work:"CrCl 22 mL/min is in the 15–29 range.\nPI maximum = 300 mg/day (one dose per day).\nRx written for 300 mg × 3 = 900 mg/day — 3× the safe maximum.\nPharmacist must contact the prescriber before dispensing." },
  // ── DAYS SUPPLY — TABLETS ──
  ...
  { id:"days_prednisone", cat:"Days Supply",
    scenario:"Prednisone 5 mg #21 tablets. Sig: 6 tabs Day 1, 5 tabs Day 2, 4 tabs Day 3, 3 tabs Day 4, 2 tabs Day 5, 1 tab Day 6.",
    q:"What is the days supply for this taper pack?",
    opts:["3 days","5 days","6 days","7 days"], ans:2,
    work:"Verify tablet count: 6+5+4+3+2+1 = 21 tablets ✓\nDosing spans 6 consecutive days.\nDays supply = 6 days" },
  { id:"days_methotrexate", cat:"Days Supply",
    scenario:"Methotrexate 2.5 mg #16 tablets. Sig: 4 tablets PO once weekly (rheumatoid arthritis dosing).",
    q:"What is the days supply?",
    opts:["14 days","21 days","28 days","30 days"], ans:2,
    work:"Tablets used per week = 4 tabs/dose × 1 dose/week = 4 tabs/week\nWeeks supplied = 16 ÷ 4 = 4 weeks\nDays supply = 4 weeks × 7 days = 28 days" },
  { id:"days_azithromycin", cat:"Days Supply",
    scenario:"Azithromycin 250 mg Z-pack (#6 tablets). Sig: 2 tabs PO on Day 1, then 1 tab once daily on Days 2–5.",
    q:"What days supply do you enter in the system?",
    opts:["3 days","4 days","5 days","6 days"], ans:2,
    work:"Day 1: 2 tablets. Days 2–5: 1 tablet each (4 tablets).\n2 + 4 = 6 tablets ✓\nCourse runs Day 1 through Day 5 = 5 days supply.\n(Tablet count 6 ≠ days supply 5 — common tech error)" },
  { id:"days_atenolol", cat:"Days Supply",
    scenario:"Atenolol 50 mg #90 tablets. Sig: 1 tab PO once daily.",
    q:"What is the days supply?",
    opts:["30 days","60 days","90 days","120 days"], ans:2,
    work:"Daily use = 1 tab/day\nDays supply = 90 tablets ÷ 1 tab/day = 90 days" },
  // ── DAYS SUPPLY — LIQUIDS ──
  { id:"days_amox_liquid", cat:"Days Supply — Liquid",
    scenario:"Amoxicillin 250 mg/5 mL suspension. Sig: 5 mL PO TID for 10 days.",
    q:"How many mL are needed to fill the complete course?",
    opts:["75 mL","100 mL","150 mL","200 mL"], ans:2,
    work:"mL per day = 5 mL × 3 doses (TID) = 15 mL/day\nTotal volume = 15 mL/day × 10 days = 150 mL" },
  { id:"days_liquid_back", cat:"Days Supply — Liquid",
    scenario:"Patient receives 120 mL of amoxicillin suspension. Sig: 10 mL PO BID.",
    q:"What is the days supply?",
    opts:["5 days","6 days","8 days","10 days"], ans:1,
    work:"Daily volume = 10 mL × 2 doses (BID) = 20 mL/day\nDays supply = 120 mL ÷ 20 mL/day = 6 days" },
  { id:"days2", cat:"Days Supply — Inhaler",
    scenario:"Albuterol HFA MDI, 200 actuations per inhaler. Sig: 2 puffs QID (4× daily) PRN. Calculate at maximum scheduled use.",
    q:"How many days does one inhaler last at maximum use?",
    opts:["12 days","20 days","25 days","50 days"], ans:2,
    work:"Daily puffs (max) = 2 puffs × 4 times/day = 8 puffs/day\nDays supply = 200 actuations ÷ 8 puffs/day = 25 days" },
  // ── PEDIATRIC DOSING ──
  ...
  { id:"peds2", cat:"Pediatric Dosing",
    scenario:"Child weighs 15 kg. Ibuprofen 10 mg/kg/dose. Available: Children's Ibuprofen 100 mg/5 mL suspension.",
    q:"How many mL per dose?",
  ...
  { id:"peds3", cat:"Pediatric Dosing",
    scenario:"Child weighs 88 lbs. Prescriber orders amoxicillin 25 mg/kg/day.",
    q:"What is the total daily dose in mg?",
    opts:["500 mg","800 mg","1,000 mg","2,000 mg"], ans:2,
    work:"Convert weight: 88 lbs ÷ 2.2 = 40 kg\nTotal daily dose = 25 mg/kg × 40 kg = 1,000 mg/day" },
  { id:"peds_azith", cat:"Pediatric Dosing",
    scenario:"Child weighs 30 kg. Azithromycin suspension 200 mg/5 mL. Dose: 10 mg/kg on Day 1.",
    q:"What volume does the child receive on Day 1?",
    opts:["5.0 mL","7.5 mL","10.0 mL","12.5 mL"], ans:1,
    work:"Day 1 dose = 10 mg/kg × 30 kg = 300 mg\nVolume = 300 mg ÷ (200 mg/5 mL)\n= 300 × 5 ÷ 200 = 7.5 mL" },
  // ── ORAL LIQUID VOLUME ──
  { id:"vol_amox_dose", cat:"Oral Liquid Volume",
    scenario:"Amoxicillin oral suspension 250 mg/5 mL. Prescriber orders 375 mg per dose.",
    q:"How many mL per dose?",
    opts:["5.0 mL","6.0 mL","7.5 mL","10.0 mL"], ans:2,
    work:"Volume = Dose ÷ Concentration\n= 375 mg ÷ (250 mg/5 mL)\n= 375 × 5 ÷ 250\n= 7.5 mL" },
  { id:"vol_fluoxetine", cat:"Oral Liquid Volume",
    scenario:"Fluoxetine oral solution 20 mg/5 mL. Prescriber orders 10 mg PO once daily for a child.",
    q:"How many mL per dose?",
    opts:["1.5 mL","2.5 mL","5.0 mL","7.5 mL"], ans:1,
    work:"Volume = Dose ÷ Concentration\n= 10 mg ÷ (20 mg/5 mL)\n= 10 × 5 ÷ 20\n= 2.5 mL" },
  // ── PHARMACOKINETICS — HALF-LIFE ──
  { id:"pk1", cat:"Pharmacokinetics",
    scenario:"A patient took their last dose of a drug with a half-life of 6 hours. The plasma concentration at that time was 32 mg/L.",
    q:"What is the approximate plasma concentration 24 hours later?",
    opts:["1 mg/L","2 mg/L","4 mg/L","8 mg/L"], ans:1,
    work:"Half-lives elapsed = 24 hr ÷ 6 hr/half-life = 4 half-lives\n32 → 16 → 8 → 4 → 2 mg/L\nAfter 4 half-lives: 2 mg/L" },
  // ── PERCENT STRENGTH ──
  { id:"pct_hc", cat:"Percent Strength",
    scenario:"Hydrocortisone cream 2.5%, dispensed in a 30 g tube.",
    q:"How many mg of hydrocortisone are contained in the full tube?",
    opts:["250 mg","500 mg","750 mg","1,000 mg"], ans:2,
    work:"2.5% = 2.5 g per 100 g = 25 mg per gram\nIn 30 g: 25 mg/g × 30 g = 750 mg" },
  { id:"pct_betamethasone", cat:"Percent Strength",
    scenario:"Betamethasone valerate cream 0.1%, 45 g tube.",
    q:"How many mg of betamethasone valerate are in the tube?",
    opts:["4.5 mg","45 mg","450 mg","4,500 mg"], ans:1,
    work:"0.1% = 0.1 g per 100 g = 1 mg per gram\nIn 45 g: 1 mg/g × 45 g = 45 mg" },
  // ── mEq CALCULATIONS ──
  { id:"meq2", cat:"mEq Calculations",
    scenario:"Patient needs 60 mEq of K⁺ PO daily. Available: KCl oral solution 10 mEq / 5 mL.",
    q:"How many mL does the patient take per day?",
    opts:["15 mL","20 mL","30 mL","50 mL"], ans:2,
    work:"Volume = (Dose ÷ Concentration) × volume per unit\n= (60 mEq ÷ 10 mEq) × 5 mL\n= 6 × 5 = 30 mL" },
  { id:"meq_slowk", cat:"mEq Calculations",
    scenario:"Slow-K (KCl extended-release) tablet contains 600 mg of KCl. Molecular weight of KCl = 74.5 g/mol. K⁺ is monovalent (valence = 1).",
    q:"How many mEq of K⁺ does one Slow-K tablet contain?",
    opts:["4 mEq","6 mEq","8 mEq","10 mEq"], ans:2,
    work:"Equivalent weight = Molecular weight ÷ valence\n= 74.5 g/mol ÷ 1 = 74.5 mg/mEq\nmEq = mg ÷ Equivalent weight\n= 600 mg ÷ 74.5 mg/mEq ≈ 8.05 ≈ 8 mEq" },
  // ── REFILL ELIGIBILITY ──
  { id:"refill_90day", cat:"Refill Eligibility",
    scenario:"90-day supply dispensed on February 1. Insurance allows refill when at least 75% of the supply is used (25-day early-fill window).",
    q:"What is the earliest date this prescription can be refilled?",
    opts:["April 1","April 7","April 14","April 28"], ans:1,
    work:"Minimum days before refill = 90 − 25 = 65 days\nFeb 1 + 65 days:\n  Feb 1 → Feb 28 = 27 days\n  Mar 1 → Mar 31 = 31 more days (total 58)\n  Apr 1 → Apr 7 = 7 more days (total 65)\nEarliest refill: April 7" },
  { id:"refill_30day", cat:"Refill Eligibility",
    scenario:"30-day supply dispensed on March 15. Insurance requires 80% used before refill (6-day early-fill window).",
    q:"What is the earliest date this prescription can be refilled?",
    opts:["March 31","April 8","April 14","April 21"], ans:1,
    work:"Minimum days before refill = 30 − 6 = 24 days\nMarch 15 + 24 days:\n  March 15 → March 31 = 16 days\n  April 1 → April 8 = 8 more days (total 24)\nEarliest refill: April 8" },
  // ── IDEAL BODY WEIGHT ──
  ...
  { id:"ibw_female", cat:"Ideal Body Weight",
    scenario:"Female patient, height 5′4″ (64 inches). Devine formula: IBW (female) = 45.5 + 2.3 × (height in inches − 60).",
    q:"What is her ideal body weight?",
    opts:["48.3 kg","54.7 kg","59.8 kg","63.1 kg"], ans:1,
    work:"IBW = 45.5 + 2.3 × (64 − 60)\n= 45.5 + 2.3 × 4\n= 45.5 + 9.2\n= 54.7 kg" },
  // ── INSULIN CALCULATIONS ──
  { id:"insulin_days", cat:"Insulin — Days Supply",
    scenario:"Patient uses U-100 insulin glargine 30 units subcutaneously once daily. You dispense one 10 mL vial.",
    q:"How many days does one vial last?",
    opts:["28 days","30 days","33 days","36 days"], ans:2,
    work:"U-100 = 100 units per mL\nTotal units in vial = 100 units/mL × 10 mL = 1,000 units\nDays supply = 1,000 units ÷ 30 units/day ≈ 33.3 days → 33 days" },
  { id:"insulin_dose", cat:"Insulin — Weight-Based Dosing",
    scenario:"New-to-insulin patient. Starting dose: 0.3 units/kg/day subcutaneously. Patient weighs 80 kg.",
    q:"What is the total daily insulin dose to prescribe?",
    opts:["18 units","20 units","24 units","30 units"], ans:2,
    work:"Total daily dose = 0.3 units/kg/day × 80 kg\n= 24 units/day" },
];
